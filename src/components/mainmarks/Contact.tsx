...
import { ChangeContactPropsActionWithDispatch } from '../../types/redux/map-dispatch-to-props';
    ...
    render(){
        ...
        return (
            <React.Fragment>
                ...
                <EventListener target='window' onResize={()=>(this._changeTopLeftWidthHeight({word,wordColor,borderColor,rotate},this.props.ChangeContactProps))}></EventListener>
            </React.Fragment>
        );
    }
}
